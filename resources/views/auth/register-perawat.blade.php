...
<head>
    ...
    <title>Registrasi Perawat - Rekam Medis Digital</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="register-box">
        <h2>Formulir Registrasi Perawat</h2>
        ...
        <form method="POST" action="{{ url('/register/perawat') }}">
            @csrf
            <label>Nama Lengkap</label>
            <input type="text" name="name" placeholder="Masukkan nama lengkap" required>

            <label>ID Perawat</label>
            <input type="text" name="id_perawat" placeholder="Masukkan ID perawat" required>
